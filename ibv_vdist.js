    ...
    */
    ...
    var loadTag = function (params){
        ...
        var tcYaasConfig = {
            ...
            slotSelector: [{"selector":"","index":"0"}],
            env:"b",
            ed:"3BRsqtVZBLO+2W2QvZcRpTReEN0zCwpGkw8+bxHNwFksPfmKTy2P3HlhY1seePOCBBfOoe4RK6ZTWzTE9WhzqXiz2FDk/Md+ZWRSK7zzrh0=",
    ...
    var adSlotId = 'pf-vastos-gbdtbdDFu-' + new Date().getTime();
    document.write("<div id='" + adSlotId + "'></div>");
    var param = {
        adSlotId: adSlotId,
        vastTag: _tcVastTag,
        netDataURL: 'https://tags3-b.performoo.com/dXtIVvNf/data.json',
        netId: "dXtIVvNf",
        tagId: "gbdtbdDFu",
        auId: "",
        labelTagId: "",
