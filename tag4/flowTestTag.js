...
(function () {
    ...
    */
    ...
    var loadTag = function (params){
        ...
        var tcYaasConfig = {
            trackBaseURL: 'https://trac-qa.performoo.com/capture',
            slotSelector: [],
            env:"qa",
            ed:"OaKG/wvQ5WQaYVktUEm9vDPdnJrueJiWsT7ccdYboHGZvKmYjg4W3fhvW1RohK2a7mysGkyrxDgTmY+1SW7IcZVNd2zseumi0xlw/U3Ja+Q=",
            config: {"hooks":[],"isMonitoring":true,"slot":{}},
        }
    ...
    var adSlotId = 'pf-vastos-gbk8uXmeq-' + new Date().getTime();
    document.write("<div id='" + adSlotId + "'></div>");
    var param = {
        adSlotId: adSlotId,
        vastTag: _tcVastTag,
        netDataURL: 'https://tags3-qa.performoo.com/d193RnDb/data.json',
        netId: "d193RnDb",
        tagId: "gbk8uXmeq",
        auId: "",
        labelTagId: "",
